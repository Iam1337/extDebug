...
namespace extDebug.Menu
{
	public class DMInt32Request<T> : DMItemRequest<Int32, T>
	{
		...
		protected override DMItem BuildItem(DMBranch parent, T @object, string name, Func<Int32> getter, Action<Int32> setter, int order) => parent.Container.Add(parent, name, getter, setter, order);
