...
namespace extDebug.Menu
{
	public class DMFloatRequest<T> : DMItemRequest<float, T>
	{
		...
		protected override DMItem BuildItem(DMBranch parent, T @object, string name, Func<float> getter, Action<float> setter, int order) => parent.Container.Add(parent, name, getter, setter, order);
